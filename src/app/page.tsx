...
export default function Home() {
  ...
  return (
    <div className="mx-auto  px-4">
      ...
      <div className="flex w-full items-start gap-20 max-w-6xl mx-auto">
        ...
        <article className="mx-auto max-w-md w-full sm:w-1/2 lg:w-1/3 py-6 px-3 cursor-pointer transform duration-500 hover:-translate-y-1">
          <div className="bg-white shadow-xl rounded-lg overflow-hidden">
            ...
            <div className="p-4 py-5">
              ...
              <p className="text-3xl text-gray-900 mt-1.5 mb-1.5">
                $12,750,000
              </p>
            ...
            <div className="flex p-4 border-t border-gray-200 text-gray-700">
              <div className="flex-1 inline-flex items-center">
                ...
                <p>
                  <span className="text-gray-900 font-bold">X</span> Bedrooms
                </p>
              </div>
              <div className="flex-1 inline-flex items-center">
                <svg
                ...
                <p>
                  <span className="text-gray-900 font-bold">Y</span> Bathrooms
                </p>
              </div>
            </div>
            <div className="px-4 pt-3 pb-4 border-t border-gray-200 bg-gray-100">
              ...
              <div className="flex items-center pt-2">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(https://st.depositphotos.com/1067257/2844/v/600/depositphotos_28440617-stock-illustration-black-and-white-human-skull.jpg)",
                  }}
                ></div>
                <div>
      ...
      <section className="container mx-auto py-10 md:py-20 antialiased ">
        <section className="grid lg:grid-cols-2 2xl:grid-cols-4 grid-cols-1 gap-8">
          ...
          <article className="mx-auto max-w-sm pb-8 bg-cover bg-center cursor-pointer transform duration-500 hover:-translate-y-1 shadow-2xl rounded-xl">
            <img
              className="mx-auto mb-20 mt-10 w-40"
              src="https://penpot.app/images/open-source.webp"
              alt=""
            />
            <h2 className="text-center text-3xl mt-8 font-bold min-h-18 px-12">
              Open Source power
            ...
            <p className="m-4 text-lg p-4 leading-relaxed text-center ">
              Build for the community and empowered by the community. Extreme
              adaptability: contributions can range from add-ons and plugins to
              core functionality.
            </p>
          </article>
        </section>
      ...
      <section className="container mx-auto p-10 md:py-20 px-0 md:p-20 md:px-0 antialiased">
        <section className="grid lg:grid-cols-2 2xl:grid-cols-3 grid-cols-1 gap-40 ">
          ...
          <article
            ...
            style={{
              backgroundImage:
                "url(https://images.pexels.com/photos/3325720/pexels-photo-3325720.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500)",
            }}
          >
            <div className="bg-black bg-opacity-20 min-h-150 px-10 flex flex-wrap flex-col pt-96 hover:bg-opacity-75 transform duration-300">
              <h1 className="text-white text-3xl mb-5 transform translate-y-20 group-hover:translate-y-0 duration-300">
          ...
          <article
            ...
            style={{
              backgroundImage:
                "url(https://images.pexels.com/photos/3304855/pexels-photo-3304855.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)",
            }}
          >
            <div className="bg-black bg-opacity-20 min-h-150 px-10 flex flex-wrap flex-col pt-96 hover:bg-opacity-75 transform duration-300">
              <h1 className="text-white text-3xl mb-5 transform translate-y-20 group-hover:translate-y-0 duration-300">
      ...
      <section className="container mx-auto p-10 md:py-20 px-5 md:p-10">
        <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10">
            ...
            <div className="mt-14 px-4">
              ...
              <p className="mt-2 text-2xl text-gray-700">
                ...
                <a
                  ...
                  target="_blank"
                  href="https://unsplash.com/photos/zNN6ubHmruI"
                >
                  Robert Lukeman
                </a>{" "}
              </p>
          ...
          <article className="mx-auto group w-full shadow-2xl max-w-md pb-8 rounded-b-2xl transform duration-500 hover:-translate-y-2 cursor-pointer group">
            <section
              ...
              style={{
                backgroundImage:
                  "url(https://images.unsplash.com/photo-1433838552652-f9a46b332c40?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTJ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=100)",
              }}
            >
              <div className="flex items-end w-full h-full bg-black bg-opacity-20 text-white text-sm font-bold  p-4 rounded-2xl">
                <div className="w-1/2 flex items-center">
                ...
                <div className="w-1/2 flex items-center flex-row-reverse">
                  ...
                  <span className="place-items-end">98</span>
                </div>
              </div>
            </section>
            <div className="my-5 p-4 flex">
              <img
                className="w-10 h-10 rounded-full "
                src="https://images.generated.photos/YBzd3k0_Ry-XxOVS_wa0Wkxp4Mpk2w1hhRPllYA58yQ/rs:fit:256:256/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yz/XzAzNDY2MjcuanBn.jpg"
                alt=""
              />
              <div className="w-full flex justify-end space-x-1">
                <img
            ...
            <div className="mt-14 px-4">
              ...
              <p className="mt-2 text-2xl text-gray-700">
                ...
                <a
                  className="cursor-pointer hover:underline"
                  target="_blank"
                  href="https://unsplash.com/photos/t7YycgAoVSw"
                >
                  Daniela Cuevas
                </a>
              </p>
          ...
          <article className="mx-auto group w-full shadow-2xl max-w-md pb-8 rounded-b-2xl transform duration-500 hover:-translate-y-2 cursor-pointer">
            <section
              ...
              style={{
                backgroundImage:
                  "url(https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTZ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=100)",
              }}
            >
              <div className="flex items-end w-full h-full bg-black bg-opacity-20 text-white text-sm font-bold  p-4 rounded-2xl">
                <div className="w-1/2 flex items-center">
                ...
                <div className="w-1/2 flex items-center flex-row-reverse">
                  ...
                  <span className="place-items-end">217</span>
                </div>
              </div>
            </section>
            <div className="my-5 p-4 flex">
              <img
                className="w-10 h-10 rounded-full "
                src="https://images.generated.photos/y99vaViCjDei2ojQZEUIZkbp2d7FiR_n8alwPHMPSMA/rs:fit:256:256/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yz/XzAyNDI0MzcuanBn.jpg"
                alt=""
              />
              <div className="w-full flex justify-end space-x-1">
                <img
            ...
            <div className="mt-14 px-4">
              ...
              <p className="mt-2 text-2xl text-gray-700">
                ...
                <a
                  className="cursor-pointer hover:underline"
                  target="_blank"
                  href="https://unsplash.com/photos/_RBcxo9AU-U"
                >
                  Robert Lukeman
                </a>
              </p>
          ...
          <article className="mx-auto group w-full shadow-2xl max-w-md pb-8 rounded-b-2xl transform duration-500 hover:-translate-y-2 cursor-pointer">
            <section
              ...
              style={{
                backgroundImage:
                  "url(https://images.unsplash.com/photo-1532274402911-5a369e4c4bb5?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTh8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=100)",
              }}
            >
              <div className="flex items-end w-full h-full bg-black bg-opacity-20 text-white text-sm font-bold  p-4 rounded-2xl">
                <div className="w-1/2 flex items-center">
            ...
            <div className="my-5 p-4 flex">
              <img
                className="w-10 h-10 rounded-full "
                src="https://images.generated.photos/dR0k2Wztn0AVEncDXA1tnOmTVMR9-QM7yTWbKSM67KU/rs:fit:256:256/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yz/XzA5MDc2NDYuanBn.jpg"
                alt=""
              />
              <div className="w-full flex justify-end space-x-1">
                <img
            ...
            <div className="mt-14 px-4">
              ...
              <p className="mt-2 text-2xl text-gray-700">
                ...
                <a
                  className="cursor-pointer hover:underline"
                  target="_blank"
                  href="https://unsplash.com/photos/K2s_YE031CA"
                >
                  Mark Hurpur
                </a>
              </p>
        ...
        <p className="text-sm leading-relaxed text-gray-400 mt-10 text-center">
          ...
          <a
            target="_blank"
            href="https://dribbble.com/shots/8157859-Travel-App"
          >
            https://dribbble.com/shots/8157859-Travel-App
          </a>
        </p>
      </section>
      <section className="container mx-auto p-10 md:py-20 px-5 md:p-10 md:px-0">
        <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10">
          <article className="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
            <div className="max-h-125 overflow-hidden">
              <img
                ...
                src="https://images.unsplash.com/photo-1615319532762-b4ccc69e5abf?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTA3fHxsYW5kc2NhcGV8ZW58MHx8MHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=100"
                alt=""
              />
            </div>
            ...
            <h2 className="font-bold text-2xl">
              Photo by{" "}
              <a target="_blank" href="https://unsplash.com/photos/YgCmUdaFkHo">
                Drew Dao
              </a>{" "}
            </h2>
          ...
          <article className="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
            <div className="max-h-125 overflow-hidden">
              <img
                className="transform duration-300 group-hover:scale-110"
                src="https://images.unsplash.com/photo-1562981943-dda9d14477f0?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTE4fHxsYW5kc2NhcGV8ZW58MHx8MHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=100"
                alt=""
              />
            </div>
            <div className="flex justify-between my-5 ">
          ...
          <article className="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
            <div className="max-h-125 overflow-hidden">
              <img
                className="transform duration-300 group-hover:scale-110"
                src="https://images.unsplash.com/photo-1475066392170-59d55d96fe51?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=100"
                alt=""
              />
            </div>
            <div className="flex justify-between my-5 ">
          ...
          <article className="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
            <div className="max-h-125 overflow-hidden">
              <img
                className="transform duration-300 group-hover:scale-110"
                src="https://images.unsplash.com/photo-1459787915554-b34915863013?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=887&q=100"
                alt=""
              />
            </div>
            <div className="flex justify-between my-5 ">
            ...
            <h2 className="font-bold text-2xl">
              Photo by{" "}
              <a target="_blank" href="https://unsplash.com/photos/CwJb7ly-iqc">
                Ashim D'Silva
              </a>
            </h2>
            <div className="flex justify-between items-center mt-3 ">
        ...
        <p className="text-sm leading-relaxed text-gray-400 mt-10 text-center">
          ...
          <a
            target="_blank"
            href="https://dribbble.com/shots/5167257-Travel-Category-Page"
          >
            Travel Category Page by Faria Anzum
          </a>
        </p>
      </section>
        ...
        <section className="p-5 md:p-0 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10 items-start ">
          <article className="relative shadow-2xl max-w-lg w-full transform duration-500 hover:-translate-y-2 cursor-pointer rounded-md">
            <div className="flex absolute right-0 top-0 w-10 h-10 bg-blue-600 text-gray-100">
              <span className="mx-auto my-auto">
                <img className="w-5 h-5" src="svgs/right-arrow.svg" />
              </span>
            </div>
            <div
              className="bg-no-repeat bg-center overflow-hidden mt-10 min-h-96"
              style={{ backgroundImage: 'url("svgs/blob-blue.svg")' }}
            >
              <img
          ...
          <article className="relative shadow-2xl max-w-lg w-full transform duration-500 hover:-translate-y-2 cursor-pointer rounded-md">
            <div className="flex absolute left-0 top-0 w-10 h-10 bg-orange-600 text-gray-100">
              <span className="mx-auto my-auto">
                <img className="w-5 h-5" src="svgs/left-arrow.svg" />
              </span>
            </div>
            <div
              className="bg-no-repeat bg-center overflow-hidden mt-10 min-h-96"
          ...
          <article className="relative shadow-2xl max-w-lg w-full transform duration-500 hover:-translate-y-2 cursor-pointer rounded-md">
            ...
            <div className="p-8 mb-10 mt-2">
              ...
              <p className="text-xbase mt-5 text-gray-400 leading-relaxed">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo
                aliquam nam inventore ut tempora alias?
              </p>
            </div>
          </article>
          <article className="relative shadow-2xl max-w-lg w-full transform duration-500 hover:-translate-y-2 cursor-pointer rounded-md">
      ...
      <section className="container mx-auto  p-10 px-0 md:p-10 md:py-32 md:px-0">
            ...
            <article className="flex items-center h-full bg-green-900  p-6">
              <div>
                ...
                <p className=" text-3xl font-xl text-white mt-2">
                  Product cards for ecommerce websites
                </p>
              </div>
            </article>
          </section>
        ...
        <p className="text-sm leading-relaxed text-gray-400 mt-10 text-center">
          ...
          <a
            target="_blank"
            href="https://dribbble.com/shots/6693601-IxD-Challenge-Day-15"
          >
            https://dribbble.com/shots/6693601-IxD-Challenge-Day-15
          </a>
        </p>
      </section>
      <section className="container mx-auto p-10 md:py-20 px-0 md:p-10 md:px-0">
      ...
      <section className="container mx-auto p-10 md:py-20 px-0 md:p-10 md:px-0">
        <section className="p-5 md:p-0 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 items-start ">
          <section className="p-5 py-12 text-left transform duration-500 hover:-translate-y-2 hover:shadow-2xl cursor-pointer">
            <img
              className="p-5"
              src="https://www.dropbox.com/s/r8845qrir3a2ote/580b585b2edbce24c47b2746.png?dl=1"
              alt=""
            />
            <h2 className="font-semibold mb-2 mt-12 text-cyan-600">
              Popular Collection
            </h2>
          ...
          <section className="p-5 py-12 text-left transform duration-500 hover:-translate-y-2 hover:shadow-2xl cursor-pointer">
            <img
              className="p-5"
              src="https://www.dropbox.com/s/lscl1uc8fpsq2ul/580b585b2edbce24c47b274c.png?dl=1"
              alt=""
            />
            <h2 className="font-semibold mb-2 mt-12 text-cyan-600">
              Popular Collection
            ...
            <h2 className="font-semibold mb-5">$29.99</h2>
            <button className="p-2 px-6 bg-yellow-500 text-white rounded-md hover:bg-yellow-600">
              Add To Cart
            </button>
          </section>
          <section className="p-5 py-12 text-left transform duration-500 hover:-translate-y-2 hover:shadow-2xl cursor-pointer relative">
            <img
              className="p-5"
              src="https://www.dropbox.com/s/vmtb36poyq3s7go/580b585b2edbce24c47b274a.png?dl=1"
              alt=""
            />
            <h2 className="font-semibold mb-2 mt-12 text-cyan-600">
              Popular Collection
            ...
            <h2 className="font-semibold mb-5">
              $38.50{" "}
              <span className="ml-2 line-through text-gray-400">$50.00</span>{" "}
            </h2>
            <button className="p-2 px-6 bg-teal-500 text-white rounded-md hover:bg-teal-600">
              Add To Cart
            </button>
          ...
          <section className="p-5 py-12 text-left transform duration-500 hover:-translate-y-2 hover:shadow-2xl cursor-pointer">
            <img
              className="p-5"
              src="https://www.dropbox.com/s/821jeb3xvke4mur/580b585b2edbce24c47b2749.png?dl=1"
              alt=""
            />
            <h2 className="font-semibold mb-2 mt-12 text-cyan-600">
              Popular Collection
            ...
            <h2 className="font-semibold mb-5">$25.99</h2>
            <button className="p-2 px-6 bg-blue-500 text-white rounded-md hover:bg-blue-600">
              Add To Cart
            </button>
          </section>
      ...
      <section className="container mx-auto p-10 md:py-20 px-0 md:p-10 md:px-0">
        <section className="p-5 md:p-0 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 items-start ">
          <section className="p-5 py-10 text-left transform duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer bg-gray-100">
            <img
              className="w-20 "
              src="https://www.dropbox.com/s/f3vre0tmd7i4wi1/66847-logo-google-telegram-drive-suite-free-hd-image.png?dl=1"
              alt=""
            />
            <h2 className="font-semibold mb-2 mt-24 text-gray-600 text-3xl">
              Google Drive
            </h2>
            <div className="progress mt-10 w-full">
              <div className="bg-gray-300 h-2 rounded-md " />
              <div className="bg-green-600 w-1/4 h-2 rounded-md -mt-2" />
            </div>
            <div className="flex flex-row justify-between mt-2 font-semibold text-xl text-gray-600">
              <span>3.75GB</span>
              <span>15GB</span>
            </div>
            <button className="mt-10 p-2 px-6 bg-blue-500 text-white rounded-md hover:bg-blue-600">
              Add Storage
            </button>
          </section>
          <section className="p-5 py-10 text-left transform duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer bg-gray-100">
            <img
              className="w-20 "
              src="https://www.dropbox.com/s/yo8tx7whbcol2it/62455-icons-storage-computer-user-file-dropbox-airdrop.png?dl=1"
              alt=""
            />
            <h2 className="font-semibold mb-2 mt-24 text-gray-600 text-3xl">
              Dropbox
            ...
            <div className="progress mt-10 w-full">
              <div className="bg-gray-300 h-2 rounded-md " />
              <div className="bg-red-500 w-3/4 h-2 rounded-md -mt-2" />
            </div>
            <div className="flex flex-row justify-between mt-2 font-semibold text-xl text-gray-600">
              <span>3.75GB</span>
              <span>5GB</span>
          ...
          <section className="p-5 py-10 text-left transform duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer bg-gray-100">
            <img
              className="w-20 "
              src="https://www.dropbox.com/s/8n3xi891qp5mx0j/mega-icon.png?dl=1"
              alt=""
            />
            <h2 className="font-semibold mb-2 mt-24 text-gray-600 text-3xl">
              Mega NZ
            ...
            <div className="progress mt-10 w-full">
              <div className="bg-gray-300 h-2 rounded-md " />
              <div className="bg-blue-500 w-1/2 h-2 rounded-md -mt-2" />
            </div>
            <div className="flex flex-row justify-between mt-2 font-semibold text-xl text-gray-600">
              <span>2.5GB</span>
              <span>5GB</span>
          ...
          <section className="p-5 py-10 text-left transform duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer bg-gray-100">
            ...
            <div className="progress mt-10 w-full">
              <div className="bg-gray-300 h-2 rounded-md " />
              <div className="bg-green-500 w-1/5 h-2 rounded-md -mt-2" />
            </div>
            <div className="flex flex-row justify-between mt-2 font-semibold text-xl text-gray-600">
              <span>1GB</span>
              <span>5GB</span>
